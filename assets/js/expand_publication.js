function setDisplay(
    ...
    extraInfoDisplay,
    allAuthorsDisplay,
    subsetAuthorsDisplay,
) {
    const elementsToDisplay = [
        {
            element: publicationDiv.querySelector(
                "div.extra-information-container",
            ),
            display: extraInfoDisplay,
        },
        {
            element: publicationDiv.querySelector("div.all-authors"),
            display: allAuthorsDisplay,
        },
        {
            element: publicationDiv.querySelector("div.subset-authors"),
            display: subsetAuthorsDisplay,
        },
    ];
...
document.addEventListener("click", (event) => {
    const isPublicationDivClicked = Array.from(publicationDivs).some((div) =>
